...
var numFeaturedArticles = featuredArticleTitles.length;
...
function init() {
	document.getElementById("event-title-one").innerHTML = articleTitlesPolitical[politicalArticle];
	document.getElementById("event-politics").setAttribute("href", articleLinksPolitical[politicalArticle]);
	document.getElementById("event-title-two").innerHTML = articleTitlesSeasonal[seasonalArticle];
	document.getElementById("event-seasonal").setAttribute("href", articleLinksSeasonal[seasonalArticle]);
}
...
function nextArticleFeatured()
{
	...
	document.getElementById("featured-event-title").innerHTML = featuredArticleTitles[featuredArticle].link("under-construction.html");
	document.getElementById("event-featured").style.backgroundImage = featuredBackgrounds[featuredArticle];
}
